...
nodejs.crypto.CryptoAlgorithm.__name__ = ["nodejs","crypto","CryptoAlgorithm"];
nodejs.events = {};
...
nws.service.BaseService = function(p_server) {
	...
	this.session = new nws.service.ServiceSession();
...
nws.service.ServiceSession = function() {
};
nws.service.ServiceSession.__name__ = ["nws","service","ServiceSession"];
nws.service.ServiceSession.prototype = {
	__class__: nws.service.ServiceSession
};
var $_, $fid = 0;
