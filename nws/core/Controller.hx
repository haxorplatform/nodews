...
class Controller extends Entity
{
	...
	private function get_application():Application { return Application.instance; }
	 ...
	 * Internals
	 */
	private var m_children		 : Array<Controller>;
	 ...
	 * @return
	 */
	public function Contains(p_entity:Controller):Bool { return m_children.indexOf(p_entity) >= 0; }
	
	/**
	 * Adds a child entity in this instance.
	 * @param	p_entity
	 */
	public function AddChild(p_entity:Controller):Void
	{
	 ...
	 * @param	p_entity
	 */
	public function RemoveChild(p_entity:Controller):Void
	{
		if (!Contains(p_entity)) return;
	 ...
	 * @return
	 */
	public function GetChild(p_index:Int):Controller { return p_index < 0 ? null : (p_index >= m_children.length ? null : m_children[p_index] ); }
	 ...
	 * @return
	 */
	public function GetChildByName(p_name:String):Controller { for (e in m_children) if (e.name == p_name) return e; return null; }
	 ...
	 * @return
	 */
	public function Find(p_path : String) : Controller
	{
		var pl : Array<String> = p_path.split(".");
		if (pl.length <= 0) return null;
		var e : Controller = this;
		while (pl.length > 0)
		{
	 ...
	 * @param	p_callback
	 */
	public function Traverse(p_callback : Controller->Bool):Void
	{
	...
	public function GetComponentInChildren(p_type : Class<Component>):Component
	{
		...
		Traverse(function(e:Controller):Bool
		{
